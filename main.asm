...
* = $2000 "Map data"
    MAP_TILES:
        .import binary "Castle_1 - Tiles.bin"
    
    COLOUR_TILES:
        .import binary "Castle_1 - TileAttribs.bin"

    CHAR_ColourS:
        .import binary "Castle_1 - CharAttribs.bin"
    
    MAP_1:
        .import binary "Castle_1 - Map (20x11).bin"

* = $6000 "Chars data"
    CHARS:
        .import binary "Castle_1 - Chars.bin"
